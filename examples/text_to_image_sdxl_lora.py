...
from onediff.utils.lora import load_and_fuse_lora
...
pipe.load_lora_weights(LORA_MODEL_ID, weight=LORA_FILENAME)
images_fusion = pipe(
...
load_and_fuse_lora(pipe, LORA_MODEL_ID, lora_scale=0.5, offload_device="cuda", offload_weight="lora")
images_fusion = pipe(
    "masterpiece, best quality, mountain",
    generator=generator,
    height=1024,
