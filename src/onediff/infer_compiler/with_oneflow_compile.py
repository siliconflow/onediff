...
from .utils import set_env_var_if_none
...
class OneflowGraph(flow.nn.Graph):
    ...
    def __init__(self, model):
        ...
        set_env_var_if_none("ONEFLOW_RUN_GRAPH_BY_VM", "1")
        set_env_var_if_none("ONEFLOW_GRAPH_DELAY_VARIABLE_OP_EXECUTION", "1")
        set_env_var_if_none("ONEFLOW_MLIR_CSE", "1")
        set_env_var_if_none("ONEFLOW_MLIR_ENABLE_INFERENCE_OPTIMIZATION", "1")
        set_env_var_if_none("ONEFLOW_MLIR_ENABLE_ROUND_TRIP", "1")
        set_env_var_if_none("ONEFLOW_MLIR_FUSE_FORWARD_OPS", "1")
        set_env_var_if_none("ONEFLOW_MLIR_FUSE_OPS_WITH_BACKWARD_IMPL", "1")
        set_env_var_if_none("ONEFLOW_MLIR_GROUP_MATMUL", "1")
        set_env_var_if_none("ONEFLOW_MLIR_PREFER_NHWC", "1")
        set_env_var_if_none("ONEFLOW_KERNEL_ENABLE_FUSED_CONV_BIAS", "1")
        set_env_var_if_none("ONEFLOW_KERNEL_ENABLE_FUSED_LINEAR", "1")
        set_env_var_if_none("ONEFLOW_KERNEL_CONV_CUTLASS_IMPL_ENABLE_TUNING_WARMUP", "1")
        set_env_var_if_none("ONEFLOW_KERNEL_GEMM_CUTLASS_IMPL_ENABLE_TUNING_WARMUP", "1")
        set_env_var_if_none("ONEFLOW_KERNEL_CONV_ENABLE_CUTLASS_IMPL", "1")
        set_env_var_if_none("ONEFLOW_KERNEL_GEMM_ENABLE_CUTLASS_IMPL", "1")
        set_env_var_if_none("ONEFLOW_CONV_ALLOW_HALF_PRECISION_ACCUMULATION", "1")
        set_env_var_if_none("ONEFLOW_MATMUL_ALLOW_HALF_PRECISION_ACCUMULATION", "1")
        set_env_var_if_none("ONEFLOW_LINEAR_EMBEDDING_SKIP_INIT", "1")
        # os.environ["ONEFLOW_KERNEL_GLU_ENABLE_DUAL_GEMM_IMPL"] = "0"
        set_env_var_if_none("ONEFLOW_MLIR_GROUP_MATMUL_QUANT", "1")
