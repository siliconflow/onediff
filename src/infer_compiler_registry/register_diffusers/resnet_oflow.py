            ...
            if self.use_conv:
                if self.name == "conv":
                    if diffusers_version < diffusers_0220_v:
                        if isinstance(self.conv, transformed_diffusers.models.lora.LoRACompatibleConv):
                    ...
                    if diffusers_version < diffusers_0220_v:
                        if isinstance(self.Conv2d_0, transformed_diffusers.models.lora.LoRACompatibleConv):
