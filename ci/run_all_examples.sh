set -ex
HF_HUB_OFFLINE=0 python3 examples/text_to_image.py --model_id=/share_nfs/hf_models/stable-diffusion-v1-5
HF_HUB_OFFLINE=0 python3 -m onediff.demo --model_id=/share_nfs/hf_models/stable-diffusion-v1-5
...
bash examples/unet_save_and_load.sh --model_id=/share_nfs/hf_models/stable-diffusion-2-1
