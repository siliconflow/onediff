...
```
python3 ./benchmarks/text_to_image.py --model PixArt-alpha/PixArt-XL-2-1024-MS --scheduler none --steps 20 --compiler none --output-image ./pixart_alpha.png
```

### Run 1024*1024 with compile
```
python3 ./benchmarks/text_to_image.py --model PixArt-alpha/PixArt-XL-2-1024-MS --scheduler none --steps 20 --compiler nexfort --output-image ./pixart_alpha.png
```
...
```
python3 ./benchmarks/text_to_image.py --model PixArt-alpha/PixArt-XL-2-1024-MS --scheduler none --steps 20 --output-image ./pixart_alpha_fp8.png \
    --compiler nexfort \
    ...
    --quantize --quantize-config '{"quant_type": "fp8_e4m3_e4m3_dynamic"}'
```
