...
from .CrossAttentionPatch_v2 import is_crossAttention_patch
...
def apply_patch_after_loading_state_dict(state_dict, input_kwargs=None, graph=None)->Dict:
    assert graph is not None
...
def has_attn2_patch(input_kwargs)->bool:
