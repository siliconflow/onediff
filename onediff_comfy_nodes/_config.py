import os
import folder_paths
__all__ = ["is_default_using_oneflow_backend", "is_default_using_nexfort_backend", "is_disable_oneflow_backend" ]
...
_disable_oneflow_backend = os.environ.get("ONEDIFF_COMFY_NODES_DISABLE_ONEFLOW_BACKEND", "0") == "1"
