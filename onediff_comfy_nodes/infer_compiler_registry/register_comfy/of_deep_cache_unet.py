...
timestep_embedding = transformed_comfy.ldm.modules.diffusionmodules.util.timestep_embedding
forward_timestep_embed = transformed_comfy.ldm.modules.diffusionmodules.openaimodel.forward_timestep_embed
apply_control = transformed_comfy.ldm.modules.diffusionmodules.openaimodel.apply_control
...
class DeepCacheUNet(Module):
    ...
    def forward(self, x, timesteps=None, context=None, y=None, control=None, transformer_options={}, **kwargs):
        ...
        num_video_frames = kwargs.get("num_video_frames", self.unet_module.default_num_video_frames)
        image_only_indicator = kwargs.get("image_only_indicator", self.unet_module.default_image_only_indicator)
        ...
        hs = []
        t_emb = timestep_embedding(timesteps, self.unet_module.model_channels, repeat_only=False).to(x.dtype)
        ...
        h = forward_timestep_embed(self.unet_module.middle_block, h, emb, context, transformer_options, time_context=time_context, num_video_frames=num_video_frames, image_only_indicator=image_only_indicator)
...
class FastDeepCacheUNet(Module):
    ...
    def forward(self, x, cache_h, timesteps=None, context=None, y=None, control=None, transformer_options={}, **kwargs):
        """
        Apply the model to an input batch.
        :param x: an [N x C x ...] Tensor of inputs.
        :param timesteps: a 1-D batch of timesteps.
